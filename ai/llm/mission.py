...
_RULE_POOL: dict[str, tuple[tuple[str, str, str], ...]] = {
    ...
    "small": (
        ...
        ("오늘 본 좋은 것 적기", "오늘 눈에 들어온 좋은 것 하나를 적어보세요.", "record"),
        ("가족과 짧은 통화", "가족에게 전화해 5분만 이야기를 나눠보세요.", "connection"),
        ("좋아하는 간식 차리기", "간단히 만들 수 있는 좋아하는 간식을 차려보세요.", "rest"),
        ("동네 한 바퀴 걷기", "동네를 천천히 한 바퀴 걸어보세요.", "activity"),
        ("함께 듣던 노래 듣기", "아이와 함께 듣던, 또는 떠오르는 노래를 들어보세요.", "remembrance"),
    ...
    "active": (
        ...
        ("기억하는 날 표시하기", "아이를 기억하고 싶은 날을 달력에 표시해보세요.", "remembrance"),
        ("좋아하는 곳에서 사진", "기분이 좋아지는 장소에서 사진을 남겨보세요.", "activity"),
        ("가벼운 운동 30분", "스트레칭이나 가벼운 운동으로 30분 몸을 움직여보세요.", "activity"),
