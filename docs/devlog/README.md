...
| 모세종 | — | [→](members/모세종.md) |
| 김윤한 | — | [→](members/김윤한.md) |
| 반소람 | 위기 차단 문구 "지금은 안전이 먼저입니다" 추가, 증상 진료 안내 Gemini 프롬프트 신규(심각도 4단계·케이스별 마무리 문장) | [→](members/반소람.md#2026-06-05-day-5) |
| 정환주 | — | [→](members/정환주.md) |
| 민경이 | — | [→](members/민경이.md) |
| 장민수 | — | [→](members/장민수.md) |
...
| 정환주 | — | [→](members/정환주.md) |
| 민경이 | — | [→](members/민경이.md) |
| 장민수 | LivePortrait 영상+TTS 음성 합치기 `merge_audio()` 구현·검증(영상 loop+음성 길이 맞춤, 립싱크❌), 팀 자료·백엔드 호환성 점검 | [→](members/장민수.md#2026-06-05-day-5) |

**팀 전체:** 멀티모달 사진→영상+음성 파이프라인 코어 완성(FFmpeg 합치기).
