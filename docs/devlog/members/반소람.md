...
- [x] **3단계 기념일 케어 알림 신규** — `prompts/anniversary.py` + `anniversary.py`
  ...
  - 테스트(`test_anniversary.py`) 22종 + 검증 도구(`validate_anniversary.py`) 추가
...
### 내일 할 일
- [ ] 백엔드 triage/funeral/anniversary API 연동 협의 (모세종님)
- [ ] corpus.json 추가 보강 (토픽당 3~5개 목표)
- [ ] `memorial.py`에 `retrieve()` 연결 (`generate_message()`에 rag_hits 실주입)
