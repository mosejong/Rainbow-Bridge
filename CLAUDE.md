...
- ✅ 반려동물 **1인칭 화법(꿈 속 작별 대화)** 은 보호자 동의 + 경고 문구 + **risk_level 0** 조건 충족 시 허용. (강사 승인 2026-06-05, 1인칭 기준 강화 2026-06-09)
  - 1인칭은 감정적으로 가장 강한 표현이라, 회복 게이트가 **최근 체크인 창 전체 risk=0**(최신 한 건만이 아님)을 확인한 뒤에만 노출. 일반 추모 컨텐츠(content_unlocked)는 risk 0~1 허용.
